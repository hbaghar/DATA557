...
iq.hist <- ggplot(data = iq.csv, aes(IQ)) + geom_histogram(binwidth = 10, color = "lightgray") + ggtitle("Histogram plot of IQ") + geom_vline(xintercept = mean(iq.csv$IQ), color = "blue", linetype = 2)
iq.hist
```
